(function () {
  ...
  const difficulties = {
    easy: { label: 'Explorer', enemySpeed: 0.82, enemyDamage: 0.78, bossHp: 0.75, startingLives: 4, score: 0.8 },
    normal: { label: 'Arcade', enemySpeed: 1, enemyDamage: 1, bossHp: 1, startingLives: 3, score: 1 },
    hard: { label: 'Overdrive', enemySpeed: 1.22, enemyDamage: 1.12, bossHp: 1.35, startingLives: 2, score: 1.35 }
  };
